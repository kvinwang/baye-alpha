...
![for流程图](http://bgwp.oschina.io/baye-alpha/doc/img/flow.jpg)
...
我们设置钩子函数`baye.hooks.tacticStage4`(详细介绍参考下文[钩子函数手册](#hooks))
...
![打开开发者工具](http://bgwp.oschina.io/baye-alpha/doc/img/open-dev.png)

###实时查看和修改引擎数据
霸业的引擎数据存放在`baye.data`对象中，浏览器控制台中输入`baye.data.`浏览器会弹出自动补全菜单，对象中有哪些属性一览无余。如图：

![自动补全](http://bgwp.oschina.io/baye-alpha/doc/img/completion.png)

查看第一个城池的归属：

![查看城池归属](http://bgwp.oschina.io/baye-alpha/doc/img/get-belong.png)

修改第一个城池的归属：

![修改城池归属](http://bgwp.oschina.io/baye-alpha/doc/img/set-belong.png)
...
![修改钩子函数](http://bgwp.oschina.io/baye-alpha/doc/img/set-hook.png)
...
![打印日志](http://bgwp.oschina.io/baye-alpha/doc/img/add-log.png)
